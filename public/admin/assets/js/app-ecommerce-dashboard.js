...
(function () {
  ...
  const pourcent = expensesRadialChartEl.getAttribute('data-pourcent');
const nbr = parseInt(pourcent, 10);
...
// Expenses Radial Bar Chart
  ...
  const pourcent2 = expensesRadialChartEl2.getAttribute('data-pourcent2');
const nbr2 = parseInt(pourcent2, 10);

const expensesRadialChartConfig2 = {
      chart: {
        height: 145,
        sparkline: {
          enabled: true
  ...
  if (typeof expensesRadialChartEl2 !== undefined && expensesRadialChartEl2 !== null) {
    const expensesRadialChart = new ApexCharts(expensesRadialChartEl2, expensesRadialChartConfig2);
    expensesRadialChart.render();
  }
  ...
  const labelsAttributeValue = generatedLeadsChartEl.getAttribute('data-labels');
  const labels = JSON.parse(labelsAttributeValue);
  const seriesAttributeValue = generatedLeadsChartEl.getAttribute('data-series');
  const series = JSON.parse(seriesAttributeValue);
  ...
  const generatedLeadsChartConfig = {
      ...
      series: series,
      colors: [
        chartColors.donut.color1,
        chartColors.donut.color2,
        chartColors.donut.color3,
        chartColors.donut.color4,
        chartColors.donut.color5,
        chartColors.donut.color6,
      ],
      stroke: {
        width: 0
      },
  ...
  const revenusMensuels = JSON.parse(totalRevenueChartEl.getAttribute('data-revenus'));
  const revenuMax = parseInt(totalRevenueChartEl.getAttribute('data-revenus-max'));
    const totalRevenueChartOptions = {
      ...
      xaxis: {
        categories: ['Janv', 'Fév', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Août', 'Sep', 'Oct', 'Nov', 'Déc'],
        labels: {
          style: {
            fontSize: '13px',
            colors: labelColor,
  ...
  // Earning Reports2 Bar Chart
  // --------------------------------------------------------------------
  const reportBarChartEl2 = document.querySelector('#reportBarChart2');
  const revenusMensuels2 = JSON.parse(reportBarChartEl2.getAttribute('data-revenus2'));
  const reportBarChartConfig2 = {
      chart: {
        height: 230,
        type: 'bar',
        toolbar: {
  ...
  if (typeof reportBarChartEl2 !== undefined && reportBarChartEl2 !== null) {
    const barChart2 = new ApexCharts(reportBarChartEl2, reportBarChartConfig2);
    barChart2.render();
  }
  ...
  const reportBarChartEl = document.querySelector('#reportBarChart'),
    reportBarChartConfig = {
      ...
      xaxis: {
        categories: ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su','Su'],
        axisBorder: {
          show: false
        },
        axisTicks: {
