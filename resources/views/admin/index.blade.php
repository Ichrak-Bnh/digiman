                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div
                                            ...
                                            <img src="/admin/assets/img/illustrations/card-website-analytics-1.png"
                            ...
                            <div class="swiper-slide">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                        <img src="/admin/assets/img/illustrations/card-website-analytics-2.png"
                                            alt="Website Analytics" width="170"
                                            class="card-website-analytics-img" />
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                        <img src="/admin/assets/img/illustrations/card-website-analytics-3.png"
                                            alt="Website Analytics" width="170"
                                            class="card-website-analytics-img" />
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <ul class="p-0 m-0">
                                <li class="d-flex align-items-center mb-4">
                                    <img src="/admin/assets/svg/flags/us.svg" alt="User"
                                ...
                                <li class="d-flex align-items-center mb-4">
                                    <img src="/admin/assets/svg/flags/br.svg" alt="User"
                                        class="rounded-circle me-3" width="34" />
                                    <div
                                        class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex align-items-center mb-4">
                                    <img src="/admin/assets/svg/flags/in.svg" alt="User"
                                        class="rounded-circle me-3" width="34" />
                                    <div
                                        class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex align-items-center mb-4">
                                    <img src="/admin/assets/svg/flags/au.svg" alt="User"
                                        class="rounded-circle me-3" width="34" />
                                    <div
                                        class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex align-items-center mb-4">
                                    <img src="/admin/assets/svg/flags/fr.svg" alt="User"
                                        class="rounded-circle me-3" width="34" />
                                    <div
                                        class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex align-items-center">
                                    <img src="/admin/assets/svg/flags/cn.svg" alt="User"
                                        class="rounded-circle me-3" width="34" />
                                    <div
                                        class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <ul class="p-0 m-0">
                                ...
                                <li class="mb-4 pb-1 d-flex justify-content-between align-items-center">
                                    <div class="badge bg-label-info rounded p-2"><i class="ti ti-link ti-sm"></i>
                                    </div>
                                    <div class="d-flex justify-content-between w-100 flex-wrap">
                                ...
                                <li class="d-flex justify-content-between align-items-center">
                                    <div class="badge bg-label-danger rounded p-2"><i class="ti ti-ban ti-sm"></i>
                                    </div>
                                    <div class="d-flex justify-content-between w-100 flex-wrap">
